              ...
              <Card className="border-none shadow-sm hover:shadow-md transition-shadow overflow-hidden group">
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-xl font-bold text-primary group-hover:underline cursor-pointer">
                    ...
                    <Badge variant="secondary" className="bg-secondary/10 text-secondary border-none uppercase text-[9px] font-black">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm leading-relaxed line-clamp-3 opacity-80">
                ...
                <CardFooter className="bg-muted/30 flex flex-col sm:flex-row gap-3 p-4">
                  ...
                  <Button variant="ghost" size="sm" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground" asChild>
      ...
      <Card className="border-none bg-primary text-primary-foreground p-10 rounded-[2.5rem] shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <Button variant="secondary" className="rounded-full font-black px-8 h-12" asChild>
              <a href="https://wa.me/0987066051" target="_blank">
                <MessageSquare className="mr-2 h-4 w-4" /> WhatsApp Us
              </a>
            </Button>
            <Button variant="outline" className="rounded-full font-black px-8 bg-transparent border-white hover:bg-white/10 h-12" asChild>
